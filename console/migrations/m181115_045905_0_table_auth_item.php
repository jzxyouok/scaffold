...
/**
 * Class m181115_045905_0_table_auth_item
 * @property \yii\db\Transaction $_transaction
 * @Github https://github.com/Hzhihua
 */
class m181115_045905_0_table_auth_item extends Migration
{
    /**
     * @inheritdoc
     */
    public function safeUp()
    {
        ...
        $this->runSuccess['addTableComment'] = $this->addCommentOnTable('{{%auth_item}}', 'RBAC-item');
